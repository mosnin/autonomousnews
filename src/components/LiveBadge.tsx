...
export default function LiveBadge({ size = "md" }: { size?: "sm" | "md" }) {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 ${padding} bg-[rgb(var(--breaking-bg))] text-[rgb(var(--breaking-fg))] font-sans font-bold uppercase tracking-kicker rounded-sm`}
